...
class _HomePageState extends State<HomePage> with RouteAware {
  ...
  void initState() {
    ...
    // ❌ Don't immediately start TTS + mic here
  }
  ...
  void didPopNext() {
    ...
    Future.delayed(const Duration(milliseconds: 300), () async {
      await _greetBackUser(); // <-- ito na ang bahala mag set ng _isSpeaking
  ...
  Future<void> _greetUser() async {
    ...
    debugPrint("🔊 Speaking greeting: $greeting");
    var result = await _flutterTts.speak(greeting);
    debugPrint("🔈 Speak result: $result");

    // ✅ Await true completion here
  ...
  Future<void> _greetBackUser() async {
    ...
    debugPrint("🔊 Speaking back greeting: $greeting");
    var result = await _flutterTts.speak(greeting);
    debugPrint("🔈 Speak result: $result");

    // Let setCompletionHandler handle _isSpeaking = false
  }

  Future<void> _startListening() async {
    if (!_isListening && !_navigating) {
  ...
  Future<void> _processCommand(String command) async {
    ...
    // 🔎 Check for cooking level request
    ...
    // 📜 Check for cooking history request
    ...
    debugPrint("🍽 Extracted dish: $extractedDish");
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (_) => const UserMenuPage()),
                      );
                    },
