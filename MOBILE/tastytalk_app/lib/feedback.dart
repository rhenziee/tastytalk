  ...
  Future<void> _submitFeedback() async {
    ...
    if (user != null) {
      await FirebaseFirestore.instance.collection('feedback').add({
        ...
        if (widget.modifiedProcedures != null)
          'modifiedProcedures': widget.modifiedProcedures,
      });
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            // Modified Procedures Section
            if (widget.modifiedProcedures != null &&
                widget.modifiedProcedures!.isNotEmpty) ...[
              const Text(
                'Modified Procedures:',
                style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
              ),
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children:
                      widget.modifiedProcedures!.asMap().entries.map((entry) {
                        return Padding(
