...
class RecipeModel {
  ...
  factory RecipeModel.fromMap(Map<String, dynamic> map) {
    ...
    // Debug: Print the rating value from database
    debugPrint('Rating from database: ${map['rating']} (type: ${map['rating'].runtimeType})');
    ...
    return RecipeModel(
      ...
      rating: (map['rating'] is num) ? (map['rating'] as num).toDouble() : (double.tryParse(map['rating']?.toString() ?? '0') ?? 4.5),
      source: map['source']?.toString().trim() ?? 'Unknown',
