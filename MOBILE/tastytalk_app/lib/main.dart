...
class _LoginScreenState extends State<LoginScreen> {
                          ...
                          child: GestureDetector(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => TermsConditionsPage(language: _selectedLanguage),
                                ),
                              );
                            },
                            child: RichText(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => SignUpPage(language: _selectedLanguage),
                          ),
                        );
                      },
                      child: Text.rich(
                    ...
                    TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => AboutPage(language: _selectedLanguage),
                          ),
                        );
                      },
                      child: Text(
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      //             : "Mangyaring i-verify ang inyong email bago mag-login.",
      //       ),
      //     ),
      //   );
